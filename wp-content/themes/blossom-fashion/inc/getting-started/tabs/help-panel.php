...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://blossomthemes.com/' . $doc_link . '-documentation/' ); ?>" title="<?php esc_attr_e( 'Visit the Documentation', 'blossom-fashion' ); ?>" target="_blank"><?php esc_html_e( 'View Documentation', 'blossom-fashion' ); ?></a>
    </div><!-- .panel-aside -->
